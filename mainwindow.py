...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.color_picker_groupbox.setGeometry(QRect(10, 320, 181, 251))
        ...
        self.normal_radiobtn.setGeometry(QRect(10, 20, 63, 20))
        ...
        self.triangle_radiobtn.setGeometry(QRect(10, 40, 64, 20))
        self.dual_radiobtn = QRadioButton(self.color_picker_groupbox)
        self.dual_radiobtn.setObjectName(u"dual_radiobtn")
        self.dual_radiobtn.setGeometry(QRect(10, 60, 47, 20))
        self.mono_radiobtn = QRadioButton(self.color_picker_groupbox)
        self.mono_radiobtn.setObjectName(u"mono_radiobtn")
        self.mono_radiobtn.setGeometry(QRect(10, 80, 55, 20))
        self.groupBox_2 = QGroupBox(self.color_picker_groupbox)
        self.groupBox_2.setObjectName(u"groupBox_2")
        self.groupBox_2.setGeometry(QRect(0, 110, 181, 141))
        ...
        self.horizontalLayoutWidget_4.setGeometry(QRect(40, 100, 101, 31))
        self.horizontalLayout_3 = QHBoxLayout(self.horizontalLayoutWidget_4)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.first_color_effect = QPushButton(self.horizontalLayoutWidget_4)
        self.first_color_effect.setObjectName(u"first_color_effect")
        self.first_color_effect.setMaximumSize(QSize(25, 25))

        self.horizontalLayout_3.addWidget(self.first_color_effect)

        self.sec_color_effect = QPushButton(self.horizontalLayoutWidget_4)
        self.sec_color_effect.setObjectName(u"sec_color_effect")
        self.sec_color_effect.setMaximumSize(QSize(25, 25))

        self.horizontalLayout_3.addWidget(self.sec_color_effect)

        self.third_color_effect = QPushButton(self.horizontalLayoutWidget_4)
        self.third_color_effect.setObjectName(u"third_color_effect")
        self.third_color_effect.setMaximumSize(QSize(25, 25))

        self.horizontalLayout_3.addWidget(self.third_color_effect)

        self.color_from_image = QPushButton(self.groupBox_2)
        self.color_from_image.setObjectName(u"color_from_image")
        self.color_from_image.setGeometry(QRect(60, 30, 62, 62))
        self.color_from_image.setMaximumSize(QSize(64, 64))
        self.color_from_image.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.color_from_image.setIconSize(QSize(99, 99))
        self.basic_filters_groupbox = QGroupBox(self.page_2)
        self.basic_filters_groupbox.setObjectName(u"basic_filters_groupbox")
        self.basic_filters_groupbox.setGeometry(QRect(10, 0, 181, 231))
        self.basic_filters_groupbox.setMinimumSize(QSize(0, 200))
        ...
        self.contrast_slider.setGeometry(QRect(130, 60, 22, 121))
        ...
        self.contrast_spinbox.setGeometry(QRect(120, 190, 42, 26))
        ...
        self.contrast_label.setGeometry(QRect(110, 20, 61, 20))
        ...
        self.contrast_chbox.setGeometry(QRect(133, 40, 16, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Set your color", None))
        ...
        self.default_btn.setText(QCoreApplication.translate("MainWindow", u"Set default settings", None))
