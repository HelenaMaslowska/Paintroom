...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stripes_btn.setEnabled(True)
        ...
        self.cancel_btn_2 = QPushButton(self.page)
        self.cancel_btn_2.setObjectName(u"cancel_btn_2")
        self.cancel_btn_2.setGeometry(QRect(100, 480, 81, 24))
        self.default_btn_2 = QPushButton(self.page)
        self.default_btn_2.setObjectName(u"default_btn_2")
        self.default_btn_2.setGeometry(QRect(20, 450, 161, 24))
        self.Settings.addItem(self.page, u"Image")
        self.page_2 = QWidget()
        self.page_2.setObjectName(u"page_2")
        self.page_2.setGeometry(QRect(0, 0, 200, 640))
        self.color_picker_groupbox = QGroupBox(self.page_2)
        self.color_picker_groupbox.setObjectName(u"color_picker_groupbox")
        self.color_picker_groupbox.setGeometry(QRect(10, 360, 181, 171))
        self.color_picker_groupbox.setMaximumSize(QSize(16777215, 16777215))
        self.color_picker_groupbox.setAlignment(Qt.AlignHCenter|Qt.AlignTop)
        self.verticalLayout_4 = QVBoxLayout(self.color_picker_groupbox)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.normal_radiobtn = QRadioButton(self.color_picker_groupbox)
        ...
        self.color_horizontal_layout.setObjectName(u"color_horizontal_layout")
        self.third_color_effect = QPushButton(self.color_picker_groupbox)
        self.third_color_effect.setObjectName(u"third_color_effect")
        self.third_color_effect.setMaximumSize(QSize(25, 25))

        self.color_horizontal_layout.addWidget(self.third_color_effect)

        self.first_color_effect = QPushButton(self.color_picker_groupbox)
        self.first_color_effect.setObjectName(u"first_color_effect")
        self.first_color_effect.setMaximumSize(QSize(25, 25))

        self.color_horizontal_layout.addWidget(self.first_color_effect)

        self.sec_color_effect = QPushButton(self.color_picker_groupbox)
        self.sec_color_effect.setObjectName(u"sec_color_effect")
        self.sec_color_effect.setMaximumSize(QSize(25, 25))

        self.color_horizontal_layout.addWidget(self.sec_color_effect)


        self.verticalLayout_4.addLayout(self.color_horizontal_layout)

        self.basic_filters_groupbox = QGroupBox(self.page_2)
        self.basic_filters_groupbox.setObjectName(u"basic_filters_groupbox")
        self.basic_filters_groupbox.setGeometry(QRect(10, 0, 181, 250))
        self.basic_filters_groupbox.setMinimumSize(QSize(0, 250))
        self.basic_filters_groupbox.setMaximumSize(QSize(16777215, 250))
        self.basic_filters_groupbox.setLayoutDirection(Qt.LeftToRight)
        self.basic_filters_groupbox.setAlignment(Qt.AlignCenter)
        self.color_slider = QSlider(self.basic_filters_groupbox)
        ...
        self.light_slider = QSlider(self.basic_filters_groupbox)
        ...
        self.contrast_slider = QSlider(self.basic_filters_groupbox)
        ...
        self.color_spinbox = QSpinBox(self.basic_filters_groupbox)
        ...
        self.light_spinbox = QSpinBox(self.basic_filters_groupbox)
        ...
        self.contrast_spinbox = QSpinBox(self.basic_filters_groupbox)
        ...
        self.color_label = QLabel(self.basic_filters_groupbox)
        self.color_label.setObjectName(u"color_label")
        self.color_label.setGeometry(QRect(20, 30, 41, 20))
        self.color_label.setAlignment(Qt.AlignCenter)
        self.light_label = QLabel(self.basic_filters_groupbox)
        ...
        self.contrast_label = QLabel(self.basic_filters_groupbox)
        ...
        self.color_chbox = QCheckBox(self.basic_filters_groupbox)
        ...
        self.light_chbox = QCheckBox(self.basic_filters_groupbox)
        ...
        self.contrast_chbox = QCheckBox(self.basic_filters_groupbox)
        ...
        self.apply_btn.setGeometry(QRect(20, 600, 81, 24))
        self.cancel_btn = QPushButton(self.page_2)
        self.cancel_btn.setObjectName(u"cancel_btn")
        self.cancel_btn.setGeometry(QRect(100, 600, 81, 24))
        self.default_btn = QPushButton(self.page_2)
        self.default_btn.setObjectName(u"default_btn")
        self.default_btn.setGeometry(QRect(20, 570, 161, 24))
        self.filters_group_box = QGroupBox(self.page_2)
        self.filters_group_box.setObjectName(u"filters_group_box")
        self.filters_group_box.setGeometry(QRect(10, 260, 181, 91))
        self.filters_group_box.setAlignment(Qt.AlignHCenter|Qt.AlignTop)
        self.verticalLayout_2 = QVBoxLayout(self.filters_group_box)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.invert_chbox = QCheckBox(self.filters_group_box)
        self.invert_chbox.setObjectName(u"invert_chbox")

        self.verticalLayout_2.addWidget(self.invert_chbox)

        self.horizontalLayout_2 = QHBoxLayout()
        self.horizontalLayout_2.setSpacing(25)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.gauss_chbox = QCheckBox(self.filters_group_box)
        self.gauss_chbox.setObjectName(u"gauss_chbox")

        self.horizontalLayout_2.addWidget(self.gauss_chbox)

        self.gauss_value = QSpinBox(self.filters_group_box)
        self.gauss_value.setObjectName(u"gauss_value")
        sizePolicy3 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(25)
        sizePolicy3.setHeightForWidth(self.gauss_value.sizePolicy().hasHeightForWidth())
        self.gauss_value.setSizePolicy(sizePolicy3)
        self.gauss_value.setMinimum(1)
        self.gauss_value.setMaximum(99)

        self.horizontalLayout_2.addWidget(self.gauss_value)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.default_btn_2.setText(QCoreApplication.translate("MainWindow", u"Set default", None))
        self.Settings.setItemText(self.Settings.indexOf(self.page), QCoreApplication.translate("MainWindow", u"Image", None))
        self.color_picker_groupbox.setTitle(QCoreApplication.translate("MainWindow", u"Color picker", None))
        ...
        self.third_color_effect.setText("")
        self.first_color_effect.setText(QCoreApplication.translate("MainWindow", u"><", None))
        self.sec_color_effect.setText("")
        self.basic_filters_groupbox.setTitle(QCoreApplication.translate("MainWindow", u"Basic filters", None))
        ...
        self.color_chbox.setText("")
        self.light_chbox.setText("")
        self.contrast_chbox.setText("")
        ...
        self.filters_group_box.setTitle(QCoreApplication.translate("MainWindow", u"Premium filters", None))
        self.invert_chbox.setText(QCoreApplication.translate("MainWindow", u"Invert colors", None))
        self.gauss_chbox.setText(QCoreApplication.translate("MainWindow", u"Gaussian blur", None))
